...
const thumbPosition = computed(() => {
  const value = parseInt(filters.value.minSalary, 10)
  const max = 100000
  const min = 30000
          ...
          <div class="text-left">
            ...
            <div class="flex space-x-4">
              <div class="flex space-x-2">
                <input type="checkbox" id="full-time" value="Full-Time" v-model="filters.type" />
                <label for="full-time">Full-Time</label>
              </div>
              <div class="flex space-x-2">
                <input type="checkbox" id="part-time" value="Part-Time" v-model="filters.type" />
                <label for="part-time">Part-Time</label>
              </div>
              <div class="flex space-x-2">
                <input type="checkbox" id="remote" value="Remote" v-model="filters.type" />
            ...
            <div class="flex space-x-4">
              ...
              <div class="flex space-x-2">
                <input type="checkbox" id="interview" value="Interview" v-model="filters.status" />
                <label for="interview">Interview</label>
              </div>
              <div class="flex space-x-2">
                <input type="checkbox" id="accepted" value="Accepted" v-model="filters.status" />
                <label for="accepted">Accepted</label>
              </div>
              <div class="flex space-x-2">
                <input type="checkbox" id="rejected" value="Rejected" v-model="filters.status" />
            ...
            <div class="flex space-x-4">
              <div class="w-full pt-10 relative">
                ...
                >
                  {{ numberWithCommas(filters.minSalary) }}€
                </div>
              </div>
            </div>
